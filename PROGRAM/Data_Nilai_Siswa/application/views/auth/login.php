...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('assets/main-responsive.css')?>">
        <link rel="stylesheet" href="<?php echo base_url('assets/all.css')?>">
        <link rel="stylesheet" href="<?php echo base_url('assets/bootstrap-colorpalette.css')?>">
        <link rel="stylesheet" href="<?php echo base_url('assets/perfect-scrollbar.css')?>">
        <link rel="stylesheet" href="<?php echo base_url('assets/theme_light.css')?>" type="text/css" id="skin_color">
    ...
    <body class="login example2">
        <table id="example" style="background-color: white;" class="table table-hover table-full-width dataTable table-bordered" cellspacing="0" width="100%">
        <td><div align='center'><font size=5>Sistem Informasi Pengolahan Data Nilai pada SDN Sukapura 01 Pagi</font>

        </div></td>
</table>

        <div class="main-login col-sm-4 col-sm-offset-4">
            <div align='fa-circle-arrow-left'><font size=5>Login</font></div>
            <!-- start: LOGIN BOX -->
            <div class="box-login">
                ...
                <fieldset>
                    <?php
                            ...
                            <?php } ?>
                            <?php
                            $data3=$this->session->flashdata('notif');
                            if($data3!=""){ ?>
                            <div class="alert alert-success"><strong> Success! </strong> <?=$data3;?></div>
                            <?php } ?>
