...
<td><p align="center"><label class="col-sm-3 control-label"><h3 align="center">DAFTAR SISWA KELAS <?php echo $siswa->Nama_Rombel; ?><br>TAHUN PELAJARAN 2017 / 2018</h3></label></p></td>
  <table border="1" cellpadding="1" cellspacing="0" width="100%">
    ...
    <td align='center' style='font-weight:bold'>Kelas</td>
      ...
      <?php $no=1; foreach ($dataSiswa1 as $siswa):?>
                        <tr>
                            ...
                            <td class='text-center' align="center"><?php if ($siswa->JK === 'L'):?>
  ...
  <div class="w3-col s4">
<?php foreach($dataSiswa1 as $siswa)?>
<tr>
    <td><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mengetahui,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
