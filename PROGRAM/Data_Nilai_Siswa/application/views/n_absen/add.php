...
<?php } ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php
            echo form_open('n_absen/add', 'role="form" class="form-horizontal"');
            ?>
...
<tr>
            ...
            <div class="form-group" hidden="">
                ...
                <div class="col-sm-2">
                   <input type="Number" required name="ID_Absen" readonly="readonly" value="<?php echo $ID_Absen; ?>" placeholder="Masukan ID" id="form-field-1" class="form-control">
                </div>
            </div>
        </td>
</tr>
...
<tr>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="TEXT" value="" name="S" placeholder="0" id="S" onkeyup="average();" class="form-control">
                </div>
        ...
        <td>
                ...
                <div class="col-sm-3">
                    <input type="TEXT" value="" name="I" placeholder="0" id="I" onkeyup="average();" class="form-control">
                </div>
            </div>
        </td>
    </tr>
...
<tr>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="TEXT" value="" name="A" placeholder="0" id="A" onkeyup="average();" class="form-control">
                </div>
