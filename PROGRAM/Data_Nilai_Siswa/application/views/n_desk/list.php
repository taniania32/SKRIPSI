    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="panel-tools">
                <?php echo anchor('n_desk/add','<i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i>',"title='Tambah Data'");?>
                ...
                <a target="_blank" class="fa fa-file-pdf-o fa-lg" title='Print List' href="<?=base_url('index.php/n_desk/printN');?>"></a>
            </div>
        </div><br>
            ...
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class='text-center' align="center">ID Mapel</th>
                        <th class='text-center' align="center">Deskripsi Pengetahuan</th>
                        <th class='text-center' align="center">Deskripsi Keterampilan</th>
                ...
                <tbody>
                    ...
                    <?php $no=1; foreach ($dataR as $row):?>
                        <tr>
                            ...
                            <td class='text-LEFT' align="center"><?php echo $row['ID_Mapel']; ?></td>
                            <td class='text-LEFT' align="center"><?php echo $row['Desk_P']; ?></td>
                            <td class='text-LEFT' align="center"><?php echo $row['Desk_K']; ?></td>
                            <td class='text-center' align="center">
                                <center>
                                    <a href="<?php echo site_url('n_desk/edit/'.$row['ID_Desk']); ?>" class="fa fa-pencil-square-o" data-original-title="Update" data-placement="top"><i class="icon-pencil5"></i></a>
                                    <a href="<?php echo site_url('n_desk/delete/'.$row['ID_Desk']); ?>" onclick="return confirm('Apakah anda ingin menghapus data ini?');" class="fa fa-trash" data-popup="tooltip" data-original-title="Delete" style="color: red" data-placement="top"><i class="icon-x"></i></a>
                  </center>     
                            </td>
                        </tr>
                    <?php  endforeach?>   
