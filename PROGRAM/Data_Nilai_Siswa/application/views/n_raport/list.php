        ...
        <div class="panel-body">
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                ...
                <tbody>
                    ...
                    <?php $no=1; foreach ($dataNilaiT as $row):?>
                        <tr>
                ...
                <?php endif;?></td>
                            ...
                            <td class='text-center' align="center">
                                <center>
                                    <a href="<?php echo site_url('n_raport/listnilai/'.$row->NISN); ?>" class="fa fa-pencil-square-o" data-original-title="Detail" data-placement="top"><i class="icon-pencil5"></i></a>
                  </center>     
                            </td>
                        </tr>
                    <?php  endforeach?>   
