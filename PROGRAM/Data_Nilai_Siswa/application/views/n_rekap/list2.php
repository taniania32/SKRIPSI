...
<?php
            echo form_open('n_rekap/listnilai', 'role="form" class="form-horizontal"');
            ...
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class='text-center' align="center" colspan="10">REKAPITULASI NILAI PENDIDIKAN PANCASILA DAN KEWARGANEGARAAN</th>
                        <th class='text-center' align="center" rowspan="3">KETERANGAN</th>
                    </tr>
                                        <tr>
                        <th class='text-center' align="center" colspan="5">PENGETAHUAN</th>
                        <th class='text-center' align="center" colspan="5">KETERAMPILAN</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <?php $no=1;  foreach ($getrow1 as $row):?>
                        <tr>
                            ...
                            <td class='text-center' id="N4" align="center"><?php echo number_format($row->N4) ?></td>
                            <td class='text-center' id="N5" align="center"><?php echo number_format($row->N5) ?></td>
                            <td class='text-center' id="N6" align="center"><?php echo number_format($row->N6) ?></td>
                            <td class='text-center' id="N7" align="center" hidden=""><?php echo number_format($row->Rata2); ?></td>
...
<div class="col-sm-1">
<a target="_blank" class="btn btn-info btn-sm" title='Print List' href="<?=base_url('index.php/n_rekap/printNilai/'.$n_rekap['ID_Rombel']);?>">PRINT</a>
