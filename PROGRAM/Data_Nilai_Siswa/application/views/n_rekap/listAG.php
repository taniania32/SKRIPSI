...
<?php
            echo form_open('n_rekap/listnilaiAG', 'role="form" class="form-horizontal"');
            ...
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class='text-center' align="center" colspan="24">REKAPITULASI NILAI AGAMA</th>
         
                    </tr>
                                        <tr>
                        <th class='text-center' align="center" colspan="12">PENGETAHUAN</th>
                        <th class='text-center' align="center" colspan="12">KETERAMPILAN</th>
                    </tr>
               ...
               <tr>
                ...
                <th class='text-center' align="center" rowspan="">3.9</th>
                <th class='text-center' align="center" rowspan="">3.10</th>
                <th class='text-center' align="center" rowspan="">3.11</th>
                <th class='text-center' align="center" rowspan="">3.14</th>
                <th class='text-center' align="center" rowspan="">3.16</th>
                ...
                <th class='text-center' align="center" rowspan="">4.9</th>
                <th class='text-center' align="center" rowspan="">4.10</th>
                <th class='text-center' align="center" rowspan="">4.11</th>
                <th class='text-center' align="center" rowspan="">4.14</th>
                <th class='text-center' align="center" rowspan="">4.16</th>
                <th class='text-center' align="center" rowspan="">NA</th>
                <th class='text-center' align="center" rowspan="">P</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <?php $no=1; foreach ($getrow1 as $row):?>
                        <tr>
                            ...
                            <td class='text-center' id="N3" align="center"><?php echo number_format($row->N9) ?></td>
                            <td class='text-center' id="N3" align="center"><?php echo number_format($row->N10) ?></td>
                            ...
                            <td class='text-center' id="N6" align="center"><?php echo number_format($row->N17) ?></td>
                            <td class='text-center' id="N6" align="center"><?php echo number_format($row->N18) ?></td>
                            <td class='text-center' id="N6" align="center"><?php echo number_format($row->N19) ?></td>
                            <td class='text-center' id="N6" align="center"><?php echo number_format($row->N20) ?></td>
...
<a target="_blank" class="btn btn-info btn-sm" title='Print List' href="<?=base_url('index.php/n_rekap/printNilaiAG/'.$n_rekap['ID_Rombel']);?>">PRINT</a>
