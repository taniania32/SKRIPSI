...
<?php
            echo form_open('n_rekap/listnilaiIPA', 'role="form" class="form-horizontal"');
            ...
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class='text-center' align="center" colspan="14">REKAPITULASI NILAI IPA</th>
                        <th class='text-center' align="center" rowspan="3">KETERANGAN</th>
                    </tr>
                                        <tr>
                        <th class='text-center' align="center" colspan="7">PENGETAHUAN</th>
                        <th class='text-center' align="center" colspan="7">KETERAMPILAN</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <?php $no=1; foreach ($getrow1 as $row):?>
                        <tr>
                            ...
                            <td class='text-center' id="N4" align="center"><?php echo number_format($row->N7) ?></td>
                            <td class='text-center' id="N5" align="center"><?php echo number_format($row->N8) ?></td>
                            <td class='text-center' id="N6" align="center"><?php echo number_format($row->N9) ?></td>
                            <td class='text-center' id="N6" align="center"><?php echo number_format($row->N10) ?></td>
...
<div class="col-sm-1">
<a target="_blank" class="btn btn-info btn-sm" title='Print List' href="<?=base_url('index.php/n_rekap/printNilaiIPA/'.$n_rekap['ID_Rombel']);?>">PRINT</a>
