...
<?php
            echo form_open('n_rekap/listnilaiIPS', 'role="form" class="form-horizontal"');
            ...
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class='text-center' align="center" colspan="12">REKAPITULASI NILAI IPS</th>
...
<div class="col-sm-1">
<a target="_blank" class="btn btn-info btn-sm" title='Print List' href="<?=base_url('index.php/n_rekap/printNilaiIPS/'.$n_rekap['ID_Rombel']);?>">PRINT</a>
