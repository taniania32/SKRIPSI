...
<?php
            echo form_open('n_rekap/listnilaiMTK', 'role="form" class="form-horizontal"');
            ...
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class='text-center' align="center" colspan="18">REKAPITULASI NILAI MATEMATIKA</th>
                        <th class='text-center' align="center" rowspan="3">KETERANGAN</th>
                    </tr>
                                        <tr>
                        <th class='text-center' align="center" colspan="9">PENGETAHUAN</th>
                        <th class='text-center' align="center" colspan="9">KETERAMPILAN</th>
                    </tr>
               ...
               <tr>
                ...
                <th class='text-center' align="center" rowspan="">3.12</th>
                ...
                <th class='text-center' align="center" rowspan="">4.12</th>
                <th class='text-center' align="center" rowspan="">NA</th>
                <th class='text-center' align="center" rowspan="">P</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <?php $no=1; foreach ($getrow1 as $row):?>
                        <tr>
                            ...
                            <td class='text-center' id="N4" align="center"><?php echo number_format($row->N8) ?></td>
...
<div class="col-sm-1">
<a target="_blank" class="btn btn-info btn-sm" title='Print List' href="<?=base_url('index.php/n_rekap/printNilaiMTK/'.$n_rekap['ID_Rombel']);?>">PRINT</a>
