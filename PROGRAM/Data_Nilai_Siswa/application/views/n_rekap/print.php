                ...
                <tbody>
                    ...
                    <?php $no=1; foreach ($getrow1 as $row):?>
                        <tr>
                            ...
                            <td class='text-center' align="center" hidden=""><?php echo number_format($row->Rata1) ?></td>
                            ...
                            <td class='text-center' id="N6" align="center"><?php echo number_format($row->Rata2)  ?></td>
                            <td class='text-center' align="center" hidden=""><?php echo number_format($row->Rata2); ?></td>
