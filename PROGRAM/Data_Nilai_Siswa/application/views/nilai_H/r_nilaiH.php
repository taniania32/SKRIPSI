...
<tr>
<td align="center" class="text-center"><p align="center" class="text-center"><label align="center" class="text-center"><h3 align="center" class="text-center">DATA NILAI PENGETAHUAN SISWA</h3></label></p></td></tr>
<tr>
...
<table><br></table>
  <table border="1" cellpadding="1" cellspacing="0" width="100%">
    <thead>
      ...
      <td align='center' style='font-weight:bold' colspan="9">PENGETAHUAN</td>
...
<tr>
        ...
        <td align='center' style='font-weight:bold'>N_UTS</td>
        <td align='center' style='font-weight:bold'>N_UAS</td>
        <td align='center' style='font-weight:bold'>N_REKAP</td>
</tr>
                        ...
                        <tr>
                            ...
                            <td class='text-center' align="center"><?php echo $Nilai['N_UT']; ?></td>
                            <td class='text-center' align="center"><?php echo $Nilai['N_UAS']; ?></td>
                            <td class='text-center' align="center"><?php echo $Nilai['N_R']; ?></td>
