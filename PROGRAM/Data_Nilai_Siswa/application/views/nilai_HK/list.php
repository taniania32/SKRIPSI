    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="panel-tools">
                <?php echo anchor('nilai_HK/add','<i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i>',"title='Tambah Data'");?>
                ...
                <a target="_blank" class="fa fa-file-pdf-o fa-lg" title='Print List' href="<?=base_url('index.php/nilai_HK/printN');?>"></a>
            </div>
        </div><br>
            ...
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                ...
                <?php endif;?></td>
                            ...
                            <td class='text-center' align="center">
                                <center><a href="<?php echo site_url('nilai_HK/listnilai/'.$row['ID_Nilai_H_K']); ?>" class="fa fa-newspaper-o" data-original-title="Detail" data-placement="top"><i class="icon-book"></i></a>
                  </center>     
                            </td>
                        </tr>
                    <?php  endforeach?>   
