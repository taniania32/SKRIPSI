...
<h1>List Data Nilai</h1>							
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php
            echo form_open('nilai_Hk/list', 'role="form" class="form-horizontal"');
            echo form_hidden('ID_Nilai_H_K', $nilai_Hk['ID_Nilai_H_K']);
            ?>
          ...
          <tr>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                <?php
                    echo form_dropdown('Semester', array('1' => 'Ganjil', '2' => 'Genap'), $nilai_Hk['Semester'], "class='form-control' readonly");
                    ?>
                </div>
            </div>            
            </td>
...
<tr>
    ...
    <h4>Detail Data Nilai</h4>
        ...
        <table class="table table-striped table-condensed table-bordered" id="tb_NTugas">
          <thead>
              <th align="center" class="text-center" width="20">NO</th><th align="center" width="15%" class="text-center">ID Kompetensi Dasar</th><th align="center" class="text-center">Nilai ke 1</th><th align="center" class="text-center">Nilai ke 2</th><th class="text-center" align="center">Nilai ke 4</th><th class="text-center" align="center">Nilai ke 5</th><th class="text-center" align="center">Nilai Rata-Rata</th>
        </thead>
          <tbody>
