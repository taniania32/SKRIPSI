...
<div class="page-header">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="panel-tools">
                <?php echo anchor('rombel/add','<i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i>',"title='Tambah Data'");?>
            ...
            <table id="table1" class="table table-striped table-bordered table-hover table-full-width dataTable" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class='text-center' align="center">Nama Rombel</th>
 ...
 <tbody>
                    ...
                    <?php $no=1; foreach ($dataRombel as $row):?>
                        <tr>
                            ...
                            <td class='text-center' align="center">
                                <center>
                                    <a href="<?php echo site_url('rombel/edit/'.$row['ID_Rombel']); ?>" class="fa fa-pencil-square-o" data-original-title="Update" data-placement="top"><i class="icon-pencil5"></i></a>
                                    <a href="<?php echo site_url('rombel/delete/'.$row['ID_Rombel']); ?>" onclick="return confirm('Apakah anda ingin menghapus data ini?');" class="fa fa-trash" data-popup="tooltip" data-original-title="Delete" style="color: red" data-placement="top"><i class="icon-x"></i></a>
                  </center>     
                            </td>
                        </tr>
                    <?php  endforeach?>   
